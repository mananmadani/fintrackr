...
function createPieChart(canvasId, labels, data, colorArray) {
  ...
  // Legend options to always show all (no clipping, smaller boxes etc)
...
function updatePieCharts() {
  ...
  // Log for debugging
  // console.log('Income legend:', incCats);
  // console.log('Expense legend:', expCats);
}
function initialize() {
  renderIncomeList();
  renderExpenseList();
